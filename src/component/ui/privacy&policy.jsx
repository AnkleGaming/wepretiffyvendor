        ...
        {error && (
          <div className="text-center py-12">
            ...
            <button
              ...
              className={`mt-4 bg-${Colors.primaryMain} text-white font-semibold py-2 px-6 rounded-xl hover:bg-purple-600 hover:cursor-pointer transition-all duration-200`}
            >
              Retry
            </button>
          </div>
